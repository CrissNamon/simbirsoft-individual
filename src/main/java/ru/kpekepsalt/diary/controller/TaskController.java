...
public class TaskController {
    ...
    @ApiOperation(
            ...
            value = "Get task information"
    )
    @Operation(summary = "Get task information",
            responses = {
                ...
                @ApiResponse(responseCode = "403",
                        description = "User have no permissions to see this task",
                        content = @Content(mediaType = "application/json")
                ),
    ...
    @Operation(summary = "Add task", responses = {
                ...
                @ApiResponse(responseCode = "400",
                        description = "Wrong task information",
                        content = @Content(mediaType = "application/json")
                )
    })
    ...
    public ResponseEntity<Task> addTask(
            @Parameter(description = "Task information")
    ...
    @Operation(summary = "Delete task with given id",
            responses = {
                @ApiResponse(responseCode = "200",
